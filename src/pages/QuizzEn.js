...
const QuizEn = () => {
    ...
    const handleSubmit = () => {
        ...
        const currentScore = calculateScore(userAnswer, currentWord.fr);
        ...
        <div className='flex justify-center'>
            <div className="mx-8 lg:mx-16 bg-white p-8 rounded shadow-md w-full max-w-md">
                {!isQuizStarted ? (
                    ...
                    <>
                        <h1 className="text-2xl font-bold mb-4">Quiz en Français</h1>
                        <p className="text-lg mb-4">Quel est le mot français pour "{quizWords[currentWordIndex]?.en}" ?</p>
                        <input
                            type="text"
                            value={userAnswer}
